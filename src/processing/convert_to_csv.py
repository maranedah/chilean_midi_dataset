        ...
        [
            {
                ...
                "measure_length": get_measure_length(song, note.time), #TODO: measure_length
                "duration": note.duration,
                "pitch": note.pitch,
                "velocity": note.velocity,
                "tempo": get_tempo(song, note.time), #TODO: tempo
                "time_signature": get_time_signature(song, note.time), #TODO: time_signature
...
if __name__ == "__main__":
    import muspy
    song = muspy.read_midi("Super Especial - Pienso.mid")
